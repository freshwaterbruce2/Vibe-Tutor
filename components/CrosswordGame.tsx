...
const CrosswordGame: React.FC<CrosswordGameProps> = ({ subject, onComplete, onBack }) => {
        ...
        <div className="glass-card p-8">
          ...
          <div className="space-y-4">
            {clues.map(clue => {
              ...
              return (
                <div key={clue.number} className="bg-purple-800/30 p-4 rounded-lg">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-2 text-sm text-white/60">
                        {clue.word.split('').map((_, i) => (
                          <span key={i} className="inline-block w-6 h-6 border-b-2 border-white/30 mx-0.5"></span>
                        ))}
                      </div>
                    </div>
                  </div>
