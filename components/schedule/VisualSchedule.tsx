...
import { Calendar, Clock, CheckCircle2, Circle, Play, Pause, ChevronRight } from 'lucide-react';
...
const VisualSchedule: React.FC<VisualScheduleProps> = ({ type, onStepComplete, onEditSchedule }) => {
