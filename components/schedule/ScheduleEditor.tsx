...
import { Plus, Trash2, GripVertical, Save, X, Clock } from 'lucide-react';
import type { DailySchedule, ScheduleStep, ScheduleType, CreateSchedulePayload } from '../../types/schedule';
...
const ScheduleEditor: React.FC<ScheduleEditorProps> = ({
  ...
  const updateStep = (index: number, field: keyof Omit<ScheduleStep, 'id' | 'status' | 'completedAt'>, value: any) => {
                        ...
                        <div className="flex gap-3">
                          ...
                          <div className="flex items-center gap-2 px-3 bg-white/10 border border-white/20 rounded">
                            ...
                            <input
                              ...
                              onChange={e =>
                                updateStep(stepIndex, 'estimatedMinutes', parseInt(e.target.value) || undefined)
                              }
