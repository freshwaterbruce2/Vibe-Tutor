...
import { CheckCircle2, Circle, Timer, Play, Pause, ChevronDown, ChevronUp } from 'lucide-react';
...
export const StepCard: React.FC<StepCardProps> = ({
  ...
  useEffect(() => {
    if (timerRunning && timeRemaining !== null && timeRemaining > 0) {
      ...
      // Optional: play completion sound or haptic
    }
                  ...
                  <div className="flex-1">
                    ...
                    <div className="h-1 bg-white/10 rounded-full mt-1 overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${
                            ((step.estimatedMinutes! * 60 - timeRemaining) /
