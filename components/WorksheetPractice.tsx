...
const WorksheetPractice: React.FC<WorksheetPracticeProps> = ({
  subject,
  difficulty,
  questions,
  onComplete,
        ...
        <div className="space-y-6">
          <div>
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <span className="text-sm font-semibold text-yellow-400">Question {currentIndex + 1}</span>
            </div>
          ...
          <div>
            ...
            {feedback === 'incorrect' && (
              <div className="mt-4 p-4 bg-red-500/20 border border-red-500/50 rounded-lg text-center">
                <p className="text-red-400 font-bold">✗ Not quite. The answer was: {currentQuestion.answer}</p>
              </div>
            )}
          </div>
